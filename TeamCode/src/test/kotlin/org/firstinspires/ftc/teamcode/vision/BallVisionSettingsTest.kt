...
class BallVisionSettingsTest {
    ...
    @Test
    fun defaultsProduce640x480MjpegAndSdkYellowRange() {
        ...
        assertEquals(ChannelTriple(32, 128, 0), s.detection.lower)
        assertEquals(ChannelTriple(255, 170, 120), s.detection.upper)
    ...
    fun resetToDefaultsFlagRestoresEveryFieldAndClearsItself() {
        ...
        assertFalse(BallVisionConfig.exposureManual)
