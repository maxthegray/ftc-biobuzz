...
- `TeamCode/src/main/kotlin/org/firstinspires/ftc/teamcode/core/subsystems/drive/MecanumDriveSubsystem.kt` (a real, hardware-run subsystem)
...
`MotorIO` seam when the subsystem has logic worth testing.
